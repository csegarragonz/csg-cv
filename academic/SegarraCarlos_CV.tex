...
\begin{longtable}{R{\leftColumnWidth}p{\rightColumnWidth}}
    \href{https://github.com/faasm/faasm}{Faasm} & Faasm is a distributed serverless runtime written in C++ that isolates serverless functions using WebAssembly. I implemented an LLVM-based cross-compilation toolchain and runtime libraries to execute OpenMP and MPI applications in Faasm.  I also extended the runtime to support executing WebAssembly modules inside resource-constrained Intel SGX enclaves. \\
    ...
    % I profiled the entire stack from Kubernetes, to containerd, through the VMM, guest virtual firmware, guest kernel, and guest userspace. Using my findings, I developed patches in several components in the stack drastically reducing start-up latency. \\
            &  \textit{Technologies:} Go, Rust, Kubernetes, Containerd, OVMF \\[3pt]
